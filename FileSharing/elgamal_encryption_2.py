...
class Gamal:
    def __init__(self):
        ...
        self.q = 26573
        self.g = random.randint(2, self.p) # generator known for all
        self.private_key = self.gen_key(self.p) # private key for receiver
    ...
    """
    def decrypt(self, c1, en_msg, key, p):
        dr_msg = []
        h = self.power(c1, key, p)
